                            ...
                            <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="card">
                                    <form class="form-horizontal store-update-entity" id="form-text-area"
                                          action="{{backendRouter('canbo.update', ['id' => $entity->macanbo])}}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="macanbo" value="{{ $entity->macanbo  }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="tencanbo" value="{{ $entity->tencanbo  }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="chucvu" value="{{ $entity->chucvu  }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="dtdidong" value="{{ $entity->dtdidong }}"
                                                                ...
                                                                <select class="my-select2__select2 select2-wrapper" name="makhoa" required>
                                                                    ...
                                                                    @foreach($listKhoa as $item)
                                                                        <option value="{{ arrayGet($item, 'makhoa') }}"
                                                                                {{ $entity->makhoa == arrayGet($item, 'makhoa') ? "selected" : '' }}>
