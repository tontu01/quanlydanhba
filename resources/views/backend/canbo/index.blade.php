            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- From search -->
                        <form method="GET" action="{{ backendRouter('canbo.list') }}" class="mb-5" id="form-search">
                            <div class="form-row">
                                <div class="col-md-1">
                        ...
                        <div class="card-body__head d-flex">
                            ...
                            <a href="{{backendRouter('canbo.create')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="comment-footer">
                                                <a href="{{ backendRouter('canbo.edit', ['id' => $entity->macanbo]) }}">
                                                ...
                                                <a href="#modal_confirm_delete"
                                                   ...
                                                   data-toggle="modal"
                                                   data-form-action="{{ backendRouter('canbo.destroy', ['id' => $entity->macanbo]) }}"
                                                >
                                                    Xóa
                                                </a>
                                            </div>
